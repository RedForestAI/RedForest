...
import { Linear, Skimming, Deep, Shallow, Regular, Skipping, ReReading } from "./behaviors";
...
export default function BehaviorReadingActivity(props: ReadingActivityProps) {
  ...
  const config: BehaviorConfig[] = [
    ...
    {
      name: "DEEP",
      component: <Deep behaviorIndex={behaviorIndex} setBehaviorIndex={setBehaviorIndex}/>
    },
    {
      name: "SHALLOW",
      component: <Shallow behaviorIndex={behaviorIndex} setBehaviorIndex={setBehaviorIndex}/>
    },
    {
      name: "REGULAR",
    ...
    {
      name: "REREAD",
      component: <ReReading behaviorIndex={behaviorIndex} setBehaviorIndex={setBehaviorIndex}/>
    }
  ]

...
export function DocumentDrawer(props: {files: ReadingFile[], docs: {uri: string}[], activeDocument: IDocument | undefined, setActiveDocument: (doc: IDocument) => void}){
  ...
  return (
    <div id="DocumentPane" className={`h-screen bg-base-300 w-1/4 fixed top-0 left-0 border-r border-t z-[70] transition ease-in-out duration-200 ${open ? "-translate-x-[23vw]" : ""}`}>

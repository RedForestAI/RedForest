...
export function EmptyActivityCard(props: {assignmentId: string, activities: Activity[], setActivities: any, questions: Question[][], setQuestions: any}) {
  ...
  return (
    <>
      <div className="card w-full border border-neutral m-4 cursor-pointer" onClick={openModal}>
      ...
      <dialog id="activity_selection" className="modal">
        <div className="modal-box">
          ...
          {activityOptions.map((activityOption, index) => (
            <div key={index} className="card h-1/3 w-full bg-base border border-neutral mt-2 cursor-pointer" onClick={activityOption.onClick}>
              <div className="flex flex-row h-full">
                <div className="flex justify-center items-center border-r border-neutral p-6">
